...
@Service
public class StatsClient extends ru.practicum.BaseClient {
    ...
    public ResponseEntity<Object> createHit(HitEndpointDto body) {
    ...
    public List<StatsViewDto> getStats(LocalDateTime start, LocalDateTime end,
        ...
        try {
            return Arrays.asList(objectMapper.readValue(objectMapper.writeValueAsString(response),
                    StatsViewDto[].class));
